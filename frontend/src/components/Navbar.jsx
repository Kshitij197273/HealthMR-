  ...
  return (
    <div className='flex items-center justify-between text-sm py-4 mb-5 border-b border-b-gray-400'>
      ...
      <ul className='md:flex items-start gap-5 font-medium hidden'>
        ...
        <NavLink to='/about' >
          <li className='py-1'>AI Health Tools</li>
          <hr className='border-none outline-none h-0.5 bg-gray-500 w-3/5 m-auto hidden' />
        </NavLink>
        <NavLink to='/contact' >
          <li className='py-1'>Emergency And Pharmacy</li>
          <hr className='border-none outline-none h-0.5 bg-gray-500 w-3/5 m-auto hidden' />
        </NavLink>
      </ul>
            ...
            ? <div className='flex items-center gap-2 cursor-pointer group relative'>
              ...
              <div className='absolute top-0 right-0 pt-14 text-base font-medium text-gray-600 z-20 hidden group-hover:block'>
                <div className='min-w-48 bg-stone-100 rounded flex flex-col gap-4 p-4'>
                  ...
                  <p onClick={() => navigate('/my-appointments')} className='hover:text-black cursor-pointer'>My Health Gateway</p>
                  <p onClick={() => { setToken(false); navigate('/') }} className='hover:text-black cursor-pointer'>Logout</p>
                </div>
              </div>
            </div>
            : <button onClick={() => navigate('/login')} className='bg-gray-500 text-white px-8 py-3 rounded-full font-light hidden md:block'>Create account</button>
        }
