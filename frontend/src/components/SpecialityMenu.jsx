...
const SpecialityMenu = () => {
    return (
        <div id='speciality' className='flex flex-col items-center gap-4 py-16 text-gray-800'>
            <h1 className='text-3xl font-medium'>Instant Care Access</h1>
            <p className='sm:w-1/3 text-center text-sm'>Easily explore our network of trusted doctors and book your appointment in seconds.</p>
