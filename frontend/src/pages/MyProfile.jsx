...
const MyProfile = () => {
    ...
    const [userData, setUserData] = useState({
        ...
        email: 'manish2ps2.com',
        phone: '+91 9413973399',
        address: {
            line1: '343 Patrakar Colony, Rafiganj',
            line2: 'Aurangabad, Bihar, India',
        },
        gender: 'Male',
        dob: '2005-09-23'
    })
    ...
    return (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
            ...
            <div className='mt-10'>
                {
                    isEdit
                        ? <button onClick={() => setIsEdit(false)} className='border border-gray-500 px-8 py-2 rounded-full hover:bg-gray-500 hover:text-white transition-all'>Save information</button>
                        : <button onClick={() => setIsEdit(true)} className='border border-gray-500 px-8 py-2 rounded-full hover:bg-gray-500 hover:text-white transition-all'>Edit</button>
                }
            </div>
        </div>
    )
